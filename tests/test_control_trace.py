...
class ControlTraceTests(unittest.TestCase):
    ...
    def test_compiler_writes_one_complete_trace_per_registry_control(self):
        ...
        self.assertEqual(trace["trace_completeness"], {"actual": 45, "expected": 45, "status": "PASS"})
        self.assertEqual(len(trace["controls"]), 45)
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            [
                ...
                "GRIM-STD-0022",
                "GRIM-STD-0023",
                "GRIM-STD-0024", "GRIM-STD-0025",
                "GRIM-STD-0026", "GRIM-STD-0027", "GRIM-STD-0028", "GRIM-STD-0029",
                "GRIM-STD-0030", "GRIM-STD-0031", "GRIM-STD-0032", "GRIM-STD-0033",
                "GRIM-STD-0034",
                "GRIM-STD-0035", "GRIM-STD-0036", "GRIM-STD-0037",
                "GRIM-STD-0038", "GRIM-STD-0039", "GRIM-STD-0040", "GRIM-STD-0041",
                "GRIM-STD-0042", "GRIM-STD-0043", "GRIM-STD-0044", "GRIM-STD-0045",
            ],
        )
