# Generic Browser Chat Instructions

Read `SURFACE_BOOT.md` first and follow its complete source order.

Report:

```text
[zeref] status=CHAT_SIMULATION source=uploaded-pack runtime=unavailable
```
